...
struct TeamsView: View {
    var body:some View{
        Text("semis")
            .padding()
        NavigationView{
            ForEach(SemiTeams.indices){
                (index) in
                NavigationLink(destination:teamDetail(Teams:SemiTeams[index])) {
